...
export default function App() {
  ...
  const [decisionAI, setDecisionAI] = useState<string>('deepseek-v3')
  const [juryAgents, setJuryAgents] = useState<string[]>(['deepseek-v3', 'doubao'])
  const [customCriteria, setCustomCriteria] = useState<string>('1. 回答准确性\n2. 内容完整性\n3. 逻辑清晰度\n4. 创意程度')
  const [showAddModal, setShowAddModal] = useState(false)
  const [rightPanelView, setRightPanelView] = useState<'overview' | 'results'>('overview')
